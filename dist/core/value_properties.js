...
function parseValueTypeObject(payload) {
    ...
    if (typeFromObject !== defaultValueType) {
        var propertyPath = payload.controller ? payload.controller + "." + payload.token : payload.token;
...
function parseValueTypeDefinition(payload) {
    ...
    if (type)
        return type;
    var propertyPath = payload.controller ? payload.controller + "." + payload.typeDefinition : payload.token;
...
function valueDescriptorForTokenAndTypeDefinition(payload) {
    var key = dasherize(payload.token) + "-value";
