...
import { defaultActionDescriptorFilters } from "./action_descriptor";
var Application = (function () {
    function Application(element, schema) {
        ...
        this.actionDescriptorFilters = __assign({}, defaultActionDescriptorFilters);
    }
    ...
    Application.prototype.registerActionOption = function (name, filter) {
    ...
    Application.prototype.load = function (head) {
        ...
        definitions.forEach(function (definition) {
            if (definition.controllerConstructor.shouldLoad) {
                _this.router.loadDefinition(definition);
            }
        });
    };
