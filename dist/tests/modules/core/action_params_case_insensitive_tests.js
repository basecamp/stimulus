...
var ActionParamsCaseInsensitiveTests = (function (_super) {
    __extends(ActionParamsCaseInsensitiveTests, _super);
    function ActionParamsCaseInsensitiveTests() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.identifier = ["CamelCase", "AnotherOne"];
        ...
        _this.expectedParamsForCamelCase = {
            id: 123,
    ...
    ActionParamsCaseInsensitiveTests.prototype["test clicking on the element does return its params"] = function () {
    ...
    ActionParamsCaseInsensitiveTests.prototype["test global event return element params where the action is defined"] = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    ActionParamsCaseInsensitiveTests.prototype["test passing params to namespaced controller"] = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        _a.sent();
                        this.assertActions({ identifier: "CamelCase", params: this.expectedParamsForCamelCase }, { identifier: "AnotherOne", params: { id: 234 } });
                        return [2];
                }
            });
        });
    };
    return ActionParamsCaseInsensitiveTests;
}(ActionParamsTests));
export default ActionParamsCaseInsensitiveTests;
