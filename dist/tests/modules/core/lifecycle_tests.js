...
var LifecycleTests = (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, this.reconnectControllerElement()];
                    case 1:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, this.disconnectControllerElement()];
                    case 1:
                        _a.sent();
    ...
    LifecycleTests.prototype.reconnectControllerElement = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.disconnectControllerElement()];
                    case 1:
                        _a.sent();
                        return [4, this.connectControllerElement()];
                    case 2:
                        _a.sent();
                        return [2];
                }
