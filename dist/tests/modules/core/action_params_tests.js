...
var ActionParamsTests = (function (_super) {
    ...
    ActionParamsTests.prototype["test global event return element params where the action is defined"] = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4, this.triggerEvent(this.nestedElement, "click")];
                    case 2:
                        _a.sent();
                        this.assertActions({ identifier: "c", params: this.expectedParamsForC });
                        return [2];
