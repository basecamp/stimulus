...
var TestCase = (function () {
    ...
    TestCase.defineModule = function (moduleName, qUnit) {
        ...
        qUnit.module(moduleName, function (_hooks) {
    ...
    TestCase.getTest = function (testName) {
        ...
        return function (assert) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2, this.runTest(testName, assert)];
        }); }); };
    };
    ...
    TestCase.shouldSkipTest = function (_testName) {
        return false;
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4, this.runTestBody(testName)];
                    case 2:
                        _a.sent();
                        return [3, 5];
                    case 3: return [4, this.teardown()];
                    case 4:
                        _a.sent();
                        return [7];
                    case 5: return [2];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (typeof testCase == "function") {
                    return [2, testCase.call(this)];
                }
                else {
                    return [2, Promise.reject("test not found: \"" + testName + "\"")];
                }
                return [2];
            });
        });
